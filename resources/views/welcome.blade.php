<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('https://p4.wallpaperbetter.com/wallpaper/823/487/719/still-life-noodles-eggs-food-wallpaper-preview.jpg')">
        <h1
            ...
            <span class="inline md:block">Selamat Datang di RestoranKU</span>
        </h1>
        <div class="mx-auto mt-2 text-green-50 md:text-center lg:text-lg">
            Memesan makanan dengan nyaman dan efesien salah satu service kami,Terimakasih.
        </div>
            ...
            > -->
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="https://images.homify.com/c_fill,f_auto,q_0,w_740/v1525332567/p/photo/image/2545725/pc1.jpg" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-2xl font-bold">Tentang Kami</h2>
                        <h2
